...
export default function TasksClient() {
    ...
    async function loadSessionAndTasks() {
        ...
        try {
            ...
            // If no session, just go to /login (don't show an error)
            ...
            >
                <div
                    style={{
                        ...
                        background:
                            (t.status ?? "open") === "closed" ? "rgba(255,255,255,0.14)" : "rgba(59,130,246,0.35)",
                    }}
                />
                    ...
                    <div style={styles.grid}>
                        ...
                        <section style={styles.column}>
                            ...
                            {closedTasks.length === 0 ? (
                                <div style={styles.empty}>No closed tasks yet.</div>
                            ) : (
